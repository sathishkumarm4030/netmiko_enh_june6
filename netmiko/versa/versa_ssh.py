...
class VersaSSH(BaseConnection):
    ...
    def check_config_mode(self, check_string=']'):
        ...
        return super(VersaSSH, self).check_config_mode(check_string=check_string)

    def config_mode(self, config_command='configure'):
        """Enter configuration mode."""
        return super(VersaSSH, self).config_mode(config_command=config_command)
    ...
    def strip_prompt(self, *args, **kwargs):
        ...
        a_string = super(VersaSSH, self).strip_prompt(*args, **kwargs)
